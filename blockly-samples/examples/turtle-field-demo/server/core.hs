...
import qualified Data.ByteString.Lazy.Internal  as ByteString (unpackChars)
import qualified Data.ByteString                as BS
import qualified Data.ByteString.Builder        as Builder    (toLazyByteString, lazyByteString, charUtf8, string7)
...
instance ToJSON TypeError where
  toJSON (VarNotFoundError message var) =               object ["category" .= "VARNOTFOUNDERROR", "var" .= var]
  ...
  toJSON (MaxError message m n) =                       object ["category" .= "MAXERROR", "m" .= toJSON m, "n" .= toJSON n]
  ...
  toJSON (ModulusOfContinuityError message tau) =       object ["category" .= "MODULUSOFCONTINUITYERROR", "tau" .= toJSON tau]
  toJSON (ChainError1 message code te) =                object ["category" .= "CHAINERROR1", "message" .=  message, "te" .= toJSON te]
  toJSON (ChainError2 message code te1 te2) =           object ["category" .= "CHAINERROR2", "message" .=  message, "te1" .= toJSON te1, "te1" .= toJSON te2]
  toJSON (ChainErrorMultiple message code errors) =     object ["category" .= "CHAINERRORMANY", "message" .=  message, "errors" .= toJSON errors]
...
decode'' = decode . Builder.toLazyByteString . Builder.string7
...
commandHandler inputText = process decoded
  where
    ...
    process Nothing = "{\"ERROR\":\"CONTAINERERROR\"}"
